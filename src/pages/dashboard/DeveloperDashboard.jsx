...
import { recordLogout, clearLogId } from '../../features/activityLog/activityLogSlice'
...
const DeveloperDashboard = () => {
  ...
  //   if (currentLogId) {
  //     await dispatch(recordLogout(currentLogId))
  //     dispatch(clearLogId())
  //   }
  //   dispatch(logout())
  //   navigate('/login')
  // }
 function doLogout(){
  // Record logout synchronously before navigating away
  if (currentLogId) {
    const token = localStorage.getItem('token');
    // Use api.defaults.baseURL to get the base URL
  ...
  "
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <header className="flex items-center justify-between bg-white shadow p-4">
            ...
            <div className="text-gray-500 text-sm">Welcome, Developer</div>
          </header>
