...
export const fetchProjectDetails = createAsyncThunk(
  'developerProjects/fetchDetails',
...
export const createProjectUpdate = createAsyncThunk(
  'developerProjects/createUpdate',
...
export const updateProjectStatus = createAsyncThunk(
  'developerProjects/updateStatus',
...
const developerProjectSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchDeveloperProjects.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      ...
      .addCase(fetchDeveloperProjects.rejected, (state, action) => {
        state.loading = false;
...
// Selectors
export const selectProjects = (state) => state.developerProjects?.projects || [];
export const selectSelectedProject = (state) => state.developerProjects?.selectedProject;
export const selectProjectUpdates = (state) => state.developerProjects?.projectUpdates || [];
export const selectLoading = (state) => state.developerProjects?.loading || false;
export const selectUpdateLoading = (state) => state.developerProjects?.updateLoading || false;
export const selectError = (state) => state.developerProjects?.error;
export const selectSuccess = (state) => state.developerProjects?.success || false;
export const selectFilters = (state) => state.developerProjects?.filters;
...
export default developerProjectSlice.reducer;